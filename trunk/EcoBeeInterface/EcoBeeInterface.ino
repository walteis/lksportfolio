...
void loop() {
  ...
  pin_G_V = map(emon_G.Vrms,0,1023,0,10);
  pin_Y_V = map(emon_Y.Vrms,0,1023,0,10);
  pin_Acc1_V = map(emon_Acc1.Vrms,0,1023,0,10);
  pin_W_V = map(emon_W.Vrms,0,1023,0,10);
